...
labels <- select(clin_annotations, Sample, `Disease Status`, `% Blasts`)
...
# Combine dataframes ####
# ======================= #
combined_2$PatientId = combined_2$labId

combined_2 <- rbind.fill(combined_2, temp_final_flt3)

combined_2$`% Blasts` = NULL
...
huet=read_excel("~/Desktop/MetaAML_results/raw_data/Huet_2018_Blood.xlsx")
...
hirsch_muts_diagnosis=read_excel("~/Desktop/MetaAML_results/raw_data/Hirsch_2016_Nat_Comm_mutations.xlsx", sheet = 1)
hirsch_muts_relapse=read_excel("~/Desktop/MetaAML_results/raw_data/Hirsch_2016_Nat_Comm_mutations.xlsx", sheet = 2)
...
clin_dat <- read_excel("~/Desktop/MetaAML_results/raw_data/azizi_diagnosis_relapse_aml_clinical.xlsx")
mut_dat <- read_excel("~/Desktop/MetaAML_results/raw_data/azizi_diagnosis_relapse_all_somatic_mutations.xlsx")
