...
ggsave(filename = "~/Desktop/MetaAML_results/Figure_1/Supplimental/age_by_cohort.png", dpi = 300, width = 4, height = 5, units = "in")
...
print(surv_plot)
png(filename = "~/Desktop/MetaAML_results/Figure_1/Supplimental/total_survival.png", res = 300, width = 7.5, height = 5, units = "in")
...
print(surv_plot)
png(filename = "~/Desktop/MetaAML_results/Figure_1/Supplimental/de_novo_survival.png", res = 300, width = 7.5, height = 5, units = "in")
...
ggsave(filename = "~/Desktop/MetaAML_results/Figure_1/Supplimental/vaf_by_cohort.png", dpi = 300, width = 6, height = 5, units = "in")


# mutations profiled across all cohorts
frequent_mutations = subset(final_data_matrix, final_data_matrix$mut_freq_gene >= 25) 
frequent_mutations = c(unique(frequent_mutations$Gene))

profiled_muts = as.data.frame(unique(select(final_data_matrix, Gene, Cohort)))
profiled_muts_m <- as.data.frame(table(profiled_muts))
profiled_muts_m$n_cohorts = NA

for(i in 1:length(frequent_mutations)){
  sub = subset(profiled_muts, profiled_muts$Gene == frequent_mutations[i])
  if(nrow(sub) > 10){
    print(frequent_mutations[i])
  }
}
...
ggsave(filename = "~/Desktop/MetaAML_results/Figure_1/Supplimental/vaf_by_gene.png", dpi = 300, width = 4, height = 5, units = "in")
